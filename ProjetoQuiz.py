...
questoes = [
    #Questão 1:
    {
        ...
        'resposta': '2',
        'Explicação':' Idosos estão mais propensos a desenvolver uma forma grave da COVID-19 e/ou ter complicações. Pessoas que já sofrem com outras infecções ou doenças também correm maior risco de ter seu estado de saúde seriamente agravado.',
        'pontos':'20',
        'nivel': 'F'
    #Questão 2:
        ...
        'resposta': '0',
        'Explicação':'Os principais sintomas incluem fraqueza, febre, tosse seca e, às vezes, dificuldade respiratória. No entanto, pacientes com a COVID-19 não costumam apresentar espirros e coriza, sintomas comuns em outras gripes ou resfriados.',
        'pontos':'7',
        'nivel': 'M'
    #Questão 3:
    ...
    #Questão 7:
        ...
        'resposta': '0',
        'Explicação':'Os principais sintomas de Gripe são febre, tosse, calafrio, dor no corpo e mal estar, falta de ar e dor de cabeça. E os principais sintomas do coronavírus são febre, tosse, calafrio, dor no corpo e mal estar, falta de ar, pressão baixa e dor de garganta.',
        'pontos':'7',
        'nivel': 'M'
    #Questão 8:
        ...
        'resposta': '2',
        'Explicação':'Na maioria dos casos, não deixa. Mas, em casos graves pode resultar em danos na função respiratória, danos neurológicos, cardiológicos, etc.',
        'pontos':'7',
        'nivel': 'M'
    #Questão 9:
